      ...
      <div className="bg-white border rounded-lg p-4 w-full ">
        ...
        <div className="grid gap-2 md:grid-cols-2">
          {slicedTagList.map((tag) => (
            <div key={tag} className=" border rounded-lg h-10 flex flex-col items-center justify-center hover:bg-slate-300 hover:tracking-widest hover:font-medium cursor-pointer transition-all duration-500">
